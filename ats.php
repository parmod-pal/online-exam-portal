...
<style>
   ...
   .entry-banner {
    background: url('./images/program1.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Academic Testing Services</h1>
...
$sql = "SELECT description FROM newsevents where title='Academic Testing Services' ";
echo select($sql);
?> 
</p>
