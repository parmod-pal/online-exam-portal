...
session_start();
$appid='';$enc='';
if(isset($_SESSION['gappid']))
{
	$appid=$_SESSION['gappid'];
}
...
<div class="application" id="application" style="padding:0px ;">
	...
	<div class="app" style="padding:15px;">		
		<?php 
		$resu=mysqli_query($con,"select * from rim_chronoforms_3 where cf_id='".$appid."'and encrypt='".$enc."'");		
		if($resu>0)
		{		
			...
			<div class="app_div3" id="app_div3">
				<div class="app_container1">
					...
					<tr style="width:20px !important">
						...
						<td>:</td>
						<td><?php echo wordwrap($data['houseaddress'], 50, "<br />");?></td>
					</tr>
					<tr width="100">
						<td>PERMANENT ADDRESS (INCLUDING THE PIN CODE)</td>
						<td>:</td>
						<td><?php echo wordwrap($data['peraddress'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>DATE OF BIRTH</td>
						<td>:</td>
					...
					<tr>
						...
						<td>:</td>
						<td><?php echo wordwrap ($data['gaddress'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>IN CASE OF GUARDIAN PLEASE INDICATE THE <br/>RELATIONSHIP TO THE APPLICANT</td>
						<td>:</td>
					...
					<tr>
						<td>IF PARENT/GUARDIAN IS EMPLOYED, PROVIDE <br/>DETAILS OF HIS/HER EMPLOYMENT</td>
						<td>:</td>
						<td><?php echo $data['gemployment'];?></td>
					</tr>
					<tr>
						<td style="vertical-align:top;">PLEASE INDICATE WHETHER YOU BELONG TO <br/>SPECIAL CATEGORY</td>
					...
					<hr width="800" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
					<h2>EDUCATIONAL BACKGROUND : INSTITUTE 1</h2>
					<table class="add_table1" width="800" border="0">
					
					<tr>
						<td>Name of the college and location<br/>(from the most recent)</td>
						<td>:</td>
					...
					<tr>
						...
						<td>:</td>
						<td><?php echo wordwrap ($data['period1'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>Course</td>
						<td>:</td>
					...
					<hr width="800" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
					<h2>EDUCATIONAL BACKGROUND : INSTITUTE 2</h2>
					<table class="add_table1" width="800" border="0">
					...
					<tr>
						<td>Period (From - To)</td>
						<td>:</td>
						<td><?php echo wordwrap ($data['period2'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>Course</td>
						<td>:</td>
					...
					<hr width="800" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
					<h2>EDUCATIONAL BACKGROUND : INSTITUTE 3</h2>
					<table class="add_table1" width="800" border="0">
					...
					<tr>
						<td>Period (From - To)</td>
						<td>:</td>
						<td><?php echo wordwrap ($data['period3'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>Course</td>
						<td>:</td>
					...
					<hr width="800" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
					<h2>EDUCATIONAL BACKGROUND : INSTITUTE 4</h2>
					<table class="add_table1" width="800" border="0">
					...
					<tr>
						<td>Period (From - To)</td>
						<td>:</td>
						<td><?php echo wordwrap ($data['period4'], 50, "<br />");?></td>
					</tr>
					<tr>
						<td>Course</td>
						<td>:</td>
					...
					<table width="800" border="0" class="add_table1">
					    ...
					    ?>
						<td>Name of the college and location(from the most recent)</td>
						<td>:</td>
						<td><?php echo wordwrap($data['Institution1'], 50, "<br />");?></td>
