...
<img src="images/ksou1.png" />
	<div class="app" style="padding:15px;">
	<form method="post" action="insertgenapp1.php" autocomplete="off" class="form_sty" name="frm1" enctype="multipart/form-data">
...
<tr>
		...
		<hr width="100%" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
							...
							<table class="add_table1" width="" border="0" style="margin-top:15px;">
								...
								<tr>
									<td style="vertical-align:top;">HOW DID YOU COME TO KNOW ABOUT KSOU, AND THE COURSES OFFERED?</td>
									<td style="vertical-align:top;">:</td>
...
<div class="clr"></div>
			...
			<div class="clr"></div>
						...
						<div class="address_container">		
							<h3>DECLARATION</h3>						
							 <p style="color:brown; font-size:12px;  line-height:20px; text-align:justify;">I do hereby declare that I will abide by the rules, regulations and orders framed or passed by KSOU from time to time. The information given by me in the application is true to the best of my knowledge and belief. I understandthat I will be held responsible if any incorrect or wrong information is given here, and in which case my admission is liable to be cancelled automatically. In such a case the decision of the Registrar, KSOU is final and binding.</p>
						</div>
						<div class="clr"></div>
						<hr width="100%" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
