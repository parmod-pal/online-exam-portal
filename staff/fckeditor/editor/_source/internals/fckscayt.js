...
(function()
{
	...
	ToolbarScaytComboBox.prototype.GetLabel = function()
	{
		...
		return FCKBrowserInfo.IsIE ?
				'<div class="TB_Button_Image"><img border="0" src="' + strip + '" style="top:-192px"></div>'
			:
				'<img border="0" class="TB_Button_Image" src="' + FCK_SPACER_PATH + '" style="background-position: 0px -192px;background-image: url(' + strip + ');">';
	}
