...
FCKToolbarButtonUI.prototype.Create = function( parentElement )
{
	...
	{
		// <td><div class="TB_Button_On" title="Smiley"><table cellpadding="0" cellspacing="0"><tr><td>{Image}</td><td nowrap>Toolbar Button</td><td><img border="0" class="TB_Button_Padding"></td></tr></table></div></td>
		// <td><div class="TB_Button_On" title="Smiley"><table cellpadding="0" cellspacing="0"><tr><td><img border="0" class="TB_Button_Padding"></td><td nowrap>Toolbar Button</td><td><img border="0" class="TB_Button_Padding"></td></tr></table></div></td>
...
/*
	...
	These are samples of possible {Image} values:
		...
		Strip - IE version:
			<div class="TB_Button_Image"><img border="0" src="strip.gif" style="top:-16px"></div>

		Strip : Firefox, Safari and Opera version
			<img border="0" class="TB_Button_Image" style="background-position: 0px -16px;background-image: url(strip.gif);">

		No-Strip : Browser independent:
			<img border="0" class="TB_Button_Image" src="smiley.gif">
*/
