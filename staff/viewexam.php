...
<div class="wrapper">	
	...
	<div style="width:825px;">		
		<div class="admin_panel" style="width:710px;">
			...
			<form name="mynewForm" method="post" action="deleteselectedexam.php">
				<table width="900" border="0">
					...
					$query1 = "SELECT * FROM rim_quizmain order by id desc LIMIT $start, $limit";
					...
					?>                      
							<tr style="background-color:#F2F2F2;" >	
								...
								<td width="200"><div align="center"><?php echo $data['Title'];?></div></td>	
								<td width="150"><div align="center"><?php echo $data['Category'];?></div></td>								
								<td width="80"><div align="center"><?php echo $data['Etype'];?></div></td>	
								<td width="100"><div align="center"><?php echo $data['Startdate'];?></div></td>	
								<td width="120"><div align="center"><a href='viewquestion.php?id=<?php echo $data['Id'];?>' target='_parent'> View Question </a></div></td>
								<td width="90"><div align="center"><a href='editexam.php?id=<?php echo $data['Id'];?>' target='_parent'> Edit </a></div></td>
								<td width="90"><div align="center"><a href='deleteexam.php?id=<?php echo $data['Id'];?>' target='_parent' onclick='return deletechk("Are you sure want to delete");'> Delete </a></div></td>
							</tr>					  
					<?php
						 $i++;
					}							
				...
				<div style="clear:both; margin-left:20px; margin-top:15px; text-align:center;">	
					<input type="submit" value="Delete Selected Exam/Test" name="submit" class='delete_button1' style="border:0; " onclick="return deletechecked('Are you sure want to delete');"/>
				</div>
			</form>
			</div>
		</div>
