...
<style>
   ...
   .entry-banner {
    background: url('./images/program5.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Study Abroad Facilitation</h1>
...
$sql = "SELECT description FROM newsevents where title='Study Abroad Facilitation' ";
echo select($sql);
?> 
</p>
