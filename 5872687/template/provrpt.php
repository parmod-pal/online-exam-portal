...
<div id="wrap2" class="wrap2" style="height:600px;overflow-y:scroll;overflow-x:hidden;">	
	<div id="admin"  style="margin-left:20px;margin-top:20px;font-size:12px;font-weight:bold;">	
		...
		<form method="post" action="" name="frmprint" id="frmprint">
...
<?php
	...
	?>
		...
		<p><img alt="barcode" src="../process/barcode.php?text=<?php echo $slist['admissionno'];?>" /></p>
		<!--<p style="font-family:Cambria; font-size:20px; font-weight:bold;font-style:italic;letter-spacing:1px;color:#000;">REGISTAR<br/>RIMSR</p>--></div>
