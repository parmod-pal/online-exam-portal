		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Rimsr Video</h1>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<div class="rt-vc-video rt-dark ">
																<h1 class="entry-title text-center">Rimsr Video</h1>
																<div class="rtin-item">
																	<a class="rtin-btn rt-video-popup" href="images/movie/Corporate_Film.mp4" style="width:100%;height:100%;border:0px;"><img src="images/video1.jpg"></a>
																</div>
															</div>
