...
<style>
   ...
   .entry-banner {
    background: url('./images/program2.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Expert Certificate Programs</h1>
...
$sql = "SELECT description FROM newsevents where title='Expert Certificate Programs' ";
echo select($sql);
?> 
</p>
