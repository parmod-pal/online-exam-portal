...
<style>
   ...
   .entry-banner {
    background: url('./images/program6.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Digital Literacy</h1>
												...
												<div class="wpb_wrapper">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">								
                                                           <p id="para">
															<?php
															$sql = "SELECT description FROM newsevents where title='Digital Literacy'";
															echo select($sql);
															?> 
															</p>
															
															<a class="topbar-btn btn btn-info" href="#joinnow" data-toggle="modal" style="color: #ffff;background-color: #06912a">Register</a>
															
															</br></br></br>
															<a class="topbar-btn btn btn-info" href="#slogin" data-toggle="modal">Login</a>
