...
?>
    <div class="content">
        <div class="header">
            <h1 class="page-title">View Pages</h1>
                    <ul class="breadcrumb">
...
<!--<div class="btn-toolbar list-toolbar">
    <a href="addpages.php" style="color:#fff;"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add Blog</button></a>
	<div class="btn-group">
	</div>
</div>-->
		<table class="table">
		  ...
		  <tbody>
			...
			$limit = 25;
			$allquote=select("select * from newsevents order by id desc");
			...
			$quotes=select("select * from newsevents order by id desc limit $start,$limit");
			if(count($quotes)>0 && $allquote[0] !='')
			{
				...
				<tr>
					...
					<td>
						<a href="editpages.php?urid=<?php echo $fquote['id'];?>" title="Edit"><i class="fa fa-pencil"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-danger" data-dismiss="modal" id="dpage">Delete</button>
        </div>
      </div>
    </div>
</div>
