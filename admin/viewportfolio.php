...
<div class="btn-toolbar list-toolbar">
    <a href="addportfolio.php" style="color:#fff;"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add Portfolio</button></a>
	<div class="btn-group">
	</div>
</div>
		<table class="table">
		  ...
		  <tbody>
			<?php
			$targetpage = "viewportfolio.php";
			$limit = 25;
			$allquote=select("select * from portfolio order by id desc");
			...
			$quotes=select("select * from portfolio order by id desc limit $start,$limit");			
			if(count($quotes)>0 && $allquote[0] !='')
			{
				...
				<tr>
					...
					<td>
						<a href="editportfolio.php?urid=<?php echo $fquote['id'];?>"><i class="fa fa-pencil"></i></a>
