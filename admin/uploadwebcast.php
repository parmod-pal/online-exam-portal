			...
			for($i=0;$i<count($_FILES['img']["name"]);$i++)
			{
				...
				if (in_array($extension, $allowedExts)){
					...
					move_uploaded_file($_FILES["img"]["tmp_name"][$i],
							"../images/webcast/".$fname.'/' .$_FILES["img"]["name"][$i]);
					$err=0;
				}
				else
				{
...
<div class="content">
	<div class="header">            
		<h1 class="page-title">Upload Webcast</h1>
		<ul class="breadcrumb">
			<li><a href="">Home</a> </li>          
			<li class="active">Upload Webcast</li>
		</ul>
	</div>
	<div class="main-content">            
		<ul class="nav nav-tabs">
			<li class="active"><span style="color: #555;cursor: default;background-color: #fff;border: 1px solid #ddd;border-bottom-color: transparent;padding-left:10px;padding-right:10px;padding-top:10px;"> Upload Webcast</span></li> 
		</ul>
<div class="row">
  <div class="col-md-8">
    <br>
    <div id="myTabContent" class="tab-content">
      ...
      <form name="usfrm" action="<?php echo $_SERVER['PHP_SELF'];?>" id="cusreg" method="post" enctype="multipart/form-data"> 
			...
			<div class="form-group">
				<label>Upload Webcast</label>
				<div id="imagePreview">			
				</div>
				<input type="file" name="img[]" multiple class="form-control" id="image"></input><br/>
				<span style="color:#ff4400;">Only .mp4 files allowed</span>
			</div>				
...
<hr/>
<h2 class="title">Click on the relevant folder to get the webcast. </h2>
<hr/>
