...
if($_POST){
	...
	if(empty($errors)){	
		...
		$member_details_id=insert('newsevents',$member_details_data);
		unset($_POST['submit']);		
		if ($member_details_id > 0)
		{			
			$success="<p class='outputs'>Blog Posted Successfully</p>";	
...
<div class="content">
	...
	<div class="main-content">            
		<!--<ul class="nav nav-tabs">
			<li class="active"><span style="color: #555;cursor: default;background-color: #fff;border: 1px solid #ddd;border-bottom-color: transparent;padding-left:10px;padding-right:10px;padding-top:10px;"> Add Blog</span></li> 
		</ul>-->
<div class="row">
  <div class="col-md-4">
    <br>
