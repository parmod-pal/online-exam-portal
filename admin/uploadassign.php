			...
			for($i=0;$i<count($_FILES['img']["name"]);$i++)
			{
				...
				if (in_array($extension, $allowedExts)){
					...
					move_uploaded_file($_FILES["img"]["tmp_name"][$i],
							"../images/assignments/".$fname.'/' .$_FILES["img"]["name"][$i]);
					$err=0;
				}
				else
				{
...
<div class="content">
	<div class="header">            
		<h1 class="page-title">Upload Assignments</h1>
		<ul class="breadcrumb">
			<li><a href="">Home</a> </li>          
	...
	<div class="main-content">            
		<ul class="nav nav-tabs">
			<li class="active"><span style="color: #555;cursor: default;background-color: #fff;border: 1px solid #ddd;border-bottom-color: transparent;padding-left:10px;padding-right:10px;padding-top:10px;"> Upload Assignments</span></li> 
		</ul>
<div class="row">
  <div class="col-md-8">
    <br>
...
<hr/>
<h2 class="title">Click on the relevant folder to get the assignments. </h2>
<hr/>
