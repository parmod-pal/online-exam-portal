...
<div class="main-content">            
	<div class="btn-toolbar list-toolbar">
		<a href="createuser.php" style="color:#fff;">
	...
	<table class="table">
		<thead>
		  ...
		  <tbody>
			...
			$quotes=select("select * from userdet order by id desc limit $start,$limit");			
			if(count($quotes)>0 && $allquote[0] !='')
			{
				...
				<tr>
					<td><?php echo $i;?></td>
					<td><?php echo $fquote['name'];?></td>
					<td><?php echo $fquote['emailid'];?></td>
					<td><?php echo $fquote['username'];?></td>					
					<td>
						<a href="user.php?urid=<?php echo $fquote['id'];?>"><i class="fa fa-pencil"></i></a>
