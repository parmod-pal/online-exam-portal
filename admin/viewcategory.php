...
<div class="btn-toolbar list-toolbar">
    <a href="addcategory.php" style="color:#fff;"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</button></a>
  <div class="btn-group">
  </div>
</div>
		<table class="table">
		  ...
		  <tbody>
			...
			$limit = 25;
			$allquote=select("select * from category order by id desc");
			...
			$quotes=select("select * from category order by id desc limit $start,$limit");			
			if(count($quotes)>0 && $allquote[0] !='')
			{
				...
				<tr>
					<td><?php echo $i;?></td>
					<td><?php echo $fquote['Category_type'];?></td>
					<td><?php echo $fquote['categoryname'];?></td>								
					<td>
						<a href="editcategory.php?urid=<?php echo $fquote['id'];?>"><i class="fa fa-pencil"></i></a>
