...
<div class="btn-toolbar list-toolbar">
    <a href="addnews.php" style="color:#fff;"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add News</button></a>
	<div class="btn-group">
	</div>
</div>
		<table class="table">
		  ...
		  <tbody>
			...
			$limit = 25;
			$allquote=select("select count(id) as tot from latestnews order by id desc");
