...
<div class="btn-toolbar list-toolbar">
    <a href="addtestimonial.php" style="color:#fff;"><button class="btn btn-primary"><i class="fa fa-plus"></i> Add Testimonial</button></a>
	<div class="btn-group">
	</div>
</div>
		<table class="table">
		  ...
		  <tbody>
			...
			if($quotes != false && $allquote[0] !='')
			{
				...
				<tr>
					...
					<td>
						<a href="edittestimonial.php?urid=<?php echo $fquote['id'];?>"><i class="fa fa-pencil"></i></a>
