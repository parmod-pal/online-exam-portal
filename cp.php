...
<style>
    ...
    .entry-banner {
    background: url('./images/program3.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Certificate Programs</h1>
...
$sql = "SELECT description FROM newsevents where title='Certificate Programs' ";
echo select($sql);
?> 
</p>
