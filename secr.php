...
<style>
   ...
   .entry-banner {
    background: url('./images/program4.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">SKILL ENHANCEMENT COURSES – REGULATIONS</h1>
...
$sql = "SELECT description FROM newsevents where title='SKILL ENHANCEMENT COURSES – REGULATIONS' ";
echo select($sql);
?> 
</p>
