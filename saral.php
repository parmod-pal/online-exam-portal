...
<style>
   ...
   .entry-banner {
    background: url('./images/program7.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">SARAL SHIKSHAK</h1>
								...
								<div class="entry-content">
									<div class="vc_row wpb_row vc_row-fluid vc_custom_1510748400939">
												...
												<div class="wpb_wrapper">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">								
                                                           <p id="para">
															<?php
															$sql = "SELECT description FROM newsevents where title='Saral Shikshak'";
															echo select($sql);
															?> 
															</p>
															<a class="topbar-btn btn btn-info" href="#sarallogin" data-toggle="modal">Login </a>
														</div>
													</div>
												</div>
											</div>
										...
										<!--<div class="col-md-4">
											...
											<?php include "right_program.php";?>

                                    <!--<a href="student-login.php" class="btn btn-info">Login AS SARAL SHIKSHAK </a>-->
                                    <!--<a class="topbar-btn btn btn-info" href="#sarallogin" data-toggle="modal">Login AS SARAL SHIKSHAK</a>-->
