(function() {
    ...
    function ui_border(m, s, q) {
        for (var v in q) s.style[v] = q[v]
    }

    function ui_clr(m, s, q) {
        s.getAttribute("state") || (s.style.backgroundColor = m.toolbar.backgroundColor, s.style.color = m.toolbar.fontColor, s.style.border = "none", ui_border(m, s, {
            WebkitUserSelect: "none",
            MozUserSelect: "none",
            msUserSelect: "none",
            userSelect: "none"
        }));
        s.getAttribute("state") !== q && (s.setAttribute("state", q), s.setAttribute("type", "button"), ui_border(m, s, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
            ...
            return function(S, C, I) {
                ...
                return I = C.replace(m, function(c) {
                    switch (c) {
                        ...
                        case "YY":
                            return time_hour_chart(String(T).slice(-2), 2);
                        case "YYY":
                            return time_hour_chart(String(T).slice(-3), 3);
                        case "YYYY":
                            return time_hour_chart(T, 4);
                        case "h":
                            return O % 12 || 12;
                        case "hh":
                            return time_hour_chart(O %
                                12 || 12, 2);
                        case "H":
                            return O;
                        case "HH":
                            return time_hour_chart(O, 2);
                        case "m":
                            return V;
                        case "mm":
                            return time_hour_chart(V, 2);
                        case "s":
                            return a;
                        case "ss":
                            return time_hour_chart(a, 2);
                        case "f":
                            return String(f).slice(0, 1);
                        case "ff":
                            return time_hour_chart(String(f).slice(0, 2), 2);
                        case "fff":
                            return time_hour_chart(String(f).slice(0, 3), 3);
                        case "t":
                            return 12 > O ? "a" : "p";
                        case "tt":
                            return 12 > O ? "am" : "pm";
                        ...
                        case "z":
                            return (0 < b ? "-" : "+") + Math.floor(Math.abs(b) /
                                60);
                        case "zz":
                            return (0 < b ? "-" : "+") + time_hour_chart(Math.floor(Math.abs(b) / 60), 2);
                        case "zzz":
                            return (0 < b ? "-" : "+") + time_hour_chart(Math.floor(Math.abs(b) / 60), 2) + time_hour_chart(Math.abs(b) % 60, 2);
                        default:
        ...
        V = function(m, s, q) {
            ...
            for (P = S = X = R = C = 0; 0 < I.length;)
                ...
                q = 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? s.slice(1, s.length - 1) + q : s + q : (s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", ""), q += s.replace(/[0]+/, function(m) {
                    return time_hour_chart(W, m.length)
                }));
            x = "";
   ...
   Y.prototype.setOptions = function(m, s) {
    ...
    ka.prototype.render = function(m) {
        if (0 !== this.fontSize) {
            ...
            var y = 0,
                x = this.topPadding,
                z = null;
            this.ctx.roundRect || Gy_Rect(this.ctx);
    ...
    ka.prototype.measureText = function() {
        this._lineHeight = Ui_Font(this.fontFamily, this.fontSize, this.fontWeight);
    ...
    ka.prototype._wrapText = function() {
        var m = new String(St_Split(String(this.text))),
            v = [],
            q = this.ctx.font,
            y = 0,
            x = 0;
        ...
        if (0 === this.frontSize) x = y = 0;
            ...
            for (; 0 < m.length;) {
                ...
                var S = x,
                    ...
                    y = y + F.height,
                    m = St_Split(m.slice(F.text.length, m.length));
    ...
    Ka.Chart = function() {
        ...
        function q(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                this.canvas = chart_class(c, e);
                this._preRenderCanvas = chart_class(c, e);
                this.canvas.style.position =
                    "absolute";
                this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Gy_Rect(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Gy_Rect(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = chart_class(c, e), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                        this.plotArea.ctx = this.plotArea.canvas.getContext("2d")), this.overlaidCanvas = chart_class(c, e), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", Gy_Rect(this.overlaidCanvasCtx)), this._eventManager = new ea(this), this.windowResizeHandler = P(window, "resize", function() {
                        b._updateSize() &&
                            b.render()
        ...
        function T(a, f) {
            ...
            "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
            this.lineHeight = Ui_Font(this.fontFamily, this.fontSize, this.fontWeight);
        ...
        function C(a, f, b, c, e, g) {
            ...
            this.options.crosshair && (this.crosshair = new time_hour_chart(this.chart,
        ...
        function time_hour_chart(a, f, b) {
            time_hour_chart.base.constructor.call(this, "Crosshair", "crosshair", f, null, b);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = b;
        ...
        function ea(a) {
            ...
            this.previousDataPointEventObject =
                null;
            this.ghostCanvas = chart_class(this.chart.width, this.chart.height);
        ...
        q.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled) {
                if (!this._zoomButton) {
                    var f = !1;
                    vert(this._zoomButton = document.createElement("button"));
                    ui_clr(this, this._zoomButton, "pan");
                    ...
                    P(this._zoomButton, "click", function() {
                        a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ui_clr(a, a._zoomButton,
                            "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ui_clr(a, a._zoomButton, "pan"));
                        a.render()
                    }, this.allDOMEventHandlers);
                    P(this._zoomButton, "mouseover", function() {
                        f ? f = !1 : (ui_border(a, a._zoomButton, {
                            backgroundColor: a.toolbar.backgroundColorOnHover,
                            color: a.toolbar.fontColorOnHover,
                            transition: "0.4s",
                            WebkitTransition: "0.4s"
                        }), 0 >= navigator.userAgent.search("MSIE") && ui_border(a, a._zoomButton.childNodes[0], {
                ...
                this._resetButton || (f = !1, vert(this._resetButton = document.createElement("button")), ui_clr(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor,
                    this._toolBar.appendChild(this._resetButton), P(this._resetButton, "touchstart", function(a) {
                        ...
                        a.toolTip.hide();
                        a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, ui_clr(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
                        ...
                        vert(a._zoomButton, a._resetButton);
                        a._dispatchRangeEvent("rangeChanging", "reset");
                        a.render();
                        a._dispatchRangeEvent("rangeChanged", "reset")
                    }, this.allDOMEventHandlers), P(this._resetButton, "mouseover", function() {
                        f || (ui_border(a, a._resetButton, {
                            backgroundColor: a.toolbar.backgroundColorOnHover,
                            color: a.toolbar.hoverFfontColorOnHoverontColor,
                            transition: "0.4s",
                            WebkitTransition: "0.4s"
                        }), 0 >= navigator.userAgent.search("MSIE") && ui_border(a, a._resetButton.childNodes[0], {
                            WebkitFilter: "invert(100%)",
                            filter: "invert(100%)"
                        }))
                ...
                this.zoomEnabled || this.panEnabled || (this._zoomButton ?
                    (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), mats(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))
            } else this.panEnabled = this.zoomEnabled = !1;
            this._menuButton ? this.exportEnabled ? mats(this._menuButton) : vert(this._menuButton) : this.exportEnabled && v && (f = !1, this._menuButton = document.createElement("button"), ui_clr(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), P(this._menuButton,
                "touchstart",
                function(a) {
                    f = !0
                ...
                f || (ui_border(a, a._menuButton, {
                        backgroundColor: a.toolbar.backgroundColorOnHover,
                        color: a.toolbar.fontColorOnHover
                    }), 0 >= navigator.userAgent.search("MSIE") &&
                    ui_border(a, a._menuButton.childNodes[0], {
                        WebkitFilter: "invert(100%)",
                        filter: "invert(100%)"
                    }))
                ...
                f || (ui_border(a, a._menuButton, {
                    backgroundColor: a.toolbar.backgroundColor,
                    color: a.toolbar.fontColor
                }), 0 >= navigator.userAgent.search("MSIE") && ui_border(a, a._menuButton.childNodes[0], {
                    WebkitFilter: "invert(0%)",
                    filter: "invert(0%)"
                }))
            ...
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? ui_clr(a, a._zoomButton, "zoom") : ui_clr(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText &&
                ui_clr(a, a._resetButton, "reset"));
        ...
        q.prototype._updateSize = function() {
            ...
            this.options.height ? f = this.height : this.height = f = 0 < this.container.clientHeight ? this.container.clientHeight :
                this.height;
            return this.canvas.width !== a * ia || this.canvas.height !== f * ia ? (chart_ratio(this.canvas, a, f), chart_ratio(this._preRenderCanvas, a, f), chart_ratio(this.overlaidCanvas, a, f), chart_ratio(this._eventManager.ghostCanvas, a, f), this.bounds = {
                x1: 0,
                y1: 0,
                x2: this.width,
                y2: this.height
        ...
        q.prototype.render = function(a) {
            ...
            b ? (mats(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid " +
                this.toolbar.borderColor, this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor) : (vert(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent", this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
            ...
            for (a = 0; a < this._axes.length; a++)
                if (this._axes[a].scaleBreaks && this._axes[a].scaleBreaks._appliedBreaks.length) {
                    v ? (this._breaksCanvas = chart_class(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
                    break
                }
            this._preRenderCanvas = chart_class(this.width, this.height);
            ...
            if (this.animatedRender) {
                var e = chart_class(this.width, this.height);
            ...
            for (a = 0; a < this.plotInfo.plotTypes.length; a++)
                for (var h = this.plotInfo.plotTypes[a], l = 0; l < h.plotUnits.length; l++) {
                    var t =
                        ...
                        k = null;
                    t.targetCanvas = null;
                    this.animatedRender && (t.targetCanvas = chart_class(this.width, this.height), t.targetCanvasCtx = t.targetCanvas.getContext("2d"), g = t.targetCanvasCtx.miterLimit, t.targetCanvasCtx.miterLimit = 3);
            ...
            this.animatedRender && 0 < this._indexLabels.length && (g =
                chart_class(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(g)));
            var r = this;
            ...
            this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || vert(this._zoomButton, this._resetButton);
        ...
        q.prototype.getObjectAtXY = function(a, f, b) {
            ...
            else if (v) c = get_min_sec(a, f, this._eventManager.ghostCtx);
            else
        ...
        q.prototype._plotAreaMouseUp = function(a, f) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    h && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), h && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (mats(this._zoomButton, this._resetButton), ui_clr(this, this._zoomButton, "pan"), ui_clr(this, this._resetButton,
                        "reset")))
                }
            }
            this.isDrag = !1;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== K) {
                        ...
                        if (u.reversed)
                            for (E = 0; E < K.length; E++) I[E] < ba ? (a.push(M), B.push(Z), fa = E) : (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + time_hour_chart * X) / time_hour_chart));
                        else
                            for (E = 0; E < K.length; E++) I[E] < ba ? (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + time_hour_chart *
                                X) / time_hour_chart), fa = E) : (a.push(M), B.push(Z));
        ...
        q.prototype.replaceKeywordsWithValue = function(a, f, b, c, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                a = St_Split(a.slice(1, a.length - 1));
                a = a.replace("#index", e);
                var h = null;
                try {
                    var d = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    d && 0 < d.length && (h = St_Split(d[2]), a = St_Split(d[1]))
                } catch (k) {}
                d = null;
        ...
        C.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(f / this.viewportMinimum) <
                    ...
                    this.logLabelValues.sort(Per_Time);
        ...
        C.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                for (this.intervalStartPosition =
                    this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = time_chart(new Date(this.viewportMaximum), this.interval, this.intervalType), d = n, b = this.intervalStartPosition; b < e; time_chart(b, c, this.intervalType)) {
        ...
        C.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                v ? (this.maskCanvas = chart_class(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx);
                this.maskCtx.save();
        ...
        init_chart(time_hour_chart, Y);
        time_hour_chart.prototype.render = function(a, f) {
            var b, c, e, g, h = null,
                l = h = null,
                m = "";
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared &&
                    ...
                    if (k = this.chart.getDataPointAtXY(a, f, b)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index;
                        ...
                        if (k = get_min_sec(a, f, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
