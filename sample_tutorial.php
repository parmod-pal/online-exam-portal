		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Sample Tutorial</h1>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<div class="rt-vc-video rt-dark ">
																<h1 class="entry-title text-center">Sample Tutorial</h1>
																<div class="rtin-item">
																	<a class="rtin-btn rt-video-popup" href="images/movie/demo_tutorial.mp4" style="width:100%;height:100%;border:0px;"><img src="images/video1.jpg"></a>
																</div>
															</div>
														</div>
													</div>
