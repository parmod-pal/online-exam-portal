...
<img src="images/rimsrmba.jpg" />
	<div class="app" style="padding:15px;">
	<form method="post" action="insertgenapp.php" class="form_sty" name="frm1" enctype="multipart/form-data" autocomplete="off">
...
<div class="clr"></div>
						...
						<hr width="100%" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
							...
							<div class="parner_textbox">
								...
								<input id="6_letters_code" name="6_letters_code" autocomplete="off" required type="text" style="margin-top:10px;width:250px; height:20px;"><br>
...
<script language="JavaScript" src="js/gen_validatorv4.js" type="text/javascript" xml:space="preserve"></script>
	<script language="JavaScript" type="text/javascript"
		...
		var frmvalidator  = new Validator("frm1");x 
