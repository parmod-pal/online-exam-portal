...
<img src="images/rimsr11.png" />
	<div class="app" style="padding:15px;">
	<form method="post" action="insertgenapp.php" autocomplete="off" class="form_sty" name="frm1" enctype="multipart/form-data">
		...
		<div class="app_container1">
		 ...
		 <p>PLEASE PROVIDE THE FOLLOWING DETAILS : </p>
							...
							<table width="770" border="0" class="add_table1">
<tr>
									<td>COURSE APPLIED FOR</td>
									<td>:</td>
									<td><input type="text" name="coursename" value="" id="cfor" size="70" /></td>
								</tr>
							<tr>
							...
							<table class="add_table1" width="570" border="0">
								...
								<!--<tr>
									...
									<td>
										...
										<input type="radio"name="caste" value="OTHER BACKWARD CLASSES"/> c. NON OF THE ABOVE
									</td>
								</tr>-->
...
<div class="clr"></div>
			...
			<h2>PARTICULARS OF COURSE FEE PAID</h2>
							<table class="add_table1" width="570" border="0">
								<tr>
									<td>Amount:</td>
									<td>:</td>
									<td><input type="text" name="amount" value="" size="28" /><br /></td>
								</tr>
								<tr>
									<td>Transaction I'd</td>
									<td>:</td>
								<td><input type="text" name="txnId" value="" size="28" /><br /></td>
								</tr>
								<tr>
									<td>Date</td>
									<td>:</td>
									<td><input type="text" name="date1" value="" size="28" /><br /></td>
								</tr>
								<tr>
									<td>Bank</td>
									<td>:</td>
									<td><input type="text" name="bank" value="" size="28" /><br /></td>
								</tr>
								<tr>
									<td>Branch</td>
									<td>:</td>
									<td><input type="text" name="branch" value="" size="28" /><br /></td>
								</tr>
			...
			<div class="clr"></div>
						...
						<div class="address_container">		
							<h3>DECLARATION</h3>						
							 <p style="color:brown; font-size:12px;  line-height:20px; text-align:justify;">I do hereby declare that I will abide by the rules, regulations and orders framed or passed by RIMSR from time to time. The information given by me in the application is true to the best of my knowledge and belief. I understandthat I will be held responsible if any incorrect or wrong information is given here, and in which case my admission is liable to be cancelled automatically. In such a case the decision of the Director, RIMSR is final and binding.I hereby undertake that I will use  the coursework only to meet my learning needs and I will not share the courseware and other materials with anybody, and that in case I breach this condition and other terms, NEF-RIMSR may take any action against me as per the law of the land.</p>
						</div>
						<div class="clr"></div>
						<hr width="100%" size="2" color="#cc6600" style="margin-bottom:15px; margin-top:15px;" />
							...
							<div class="parner_textbox">
								...
								<input id="6_letters_code" name="6_letters_code" type="text" autocomplete="off" required style="margin-top:10px;width:250px; height:20px;"><br>
...
<script type='text/javascript' src='js/jquery-1.11.1.min.js'></script>
	...
	$(function(){
		var cfor=localStorage.getItem('course');		
		$('#cfor').val(cfor);
