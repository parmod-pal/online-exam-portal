...
<style>
   ...
   .entry-banner {
    background: url('./images/objectives.jpg') no-repeat scroll center;
		...
		<div class="entry-banner">
			<div class="container">
				<div class="entry-banner-content">
					<h1 class="entry-title">Objectivies</h1>
...
$sql = "SELECT description FROM newsevents where title='Objectives' ";
echo select($sql);
?> 
</p>
